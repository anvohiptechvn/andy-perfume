		...
		<PageWrapper className="gap-3">
			...
			<div className="flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">Việc thu thập thông tin qua website andyperfume.com sẽ giúp chúng tôi:</p>
					<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
						...
						<li>Giúp khách hàng cập nhật các chương trình khuyến mại, giảm giá do Andy Perfume tổ chức sớm nhất</li>
						<li>Hỗ trợ khách hàng khi có khiếu nại, ý kiến một cách nhanh nhất.</li>
					</ol>

					<p className="tex-sm text-[#42495b] md:text-base">
						Andy Perfume thu thập thông tin khách hàng bao gồm: Họ Tên, Địa chỉ email, Điện thoại, Quốc gia, Tỉnh thành, Địa chỉ
					</p>
				</div>
				...
				<div className="flex flex-col gap-2.5">
					...
					<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
						...
						<li> Gửi các thông báo về các hoạt động trao đổi thông tin giữa khách hàng và website andyperfume.com;</li>
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">
						Andy Perfume sẽ lưu trữ các thông tin cá nhân do Khách hàng cung cấp trên các hệ thống nội bộ của chúng tôi trong quá trình cung cấp dịch vụ cho
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">
						Khách hàng có thể thực hiện các quyền trên bằng cách tự truy cập vào website andyperfume.com hoặc liên hệ với chúng tôi qua email hoặc địa chỉ liên
					...
					<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
						<li>Điện thoại: 0909292848</li>
						<li>Zalo: 0909292848</li>
						<li>Email: perfumeandy@gmail.com</li>
					</ol>
				</div>
				...
				<div className="flex flex-col gap-2.5">
					...
					<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
						<li>Andy Perfume sử dụng để hỗ trợ khách hàng.</li>
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">Hộ Kinh doanh Andy Perfume</p>
					<p className="tex-sm text-[#42495b] md:text-base">Số ĐKKD 41H8185878 cấp ngày 24/3/2022 tại UBND Quận Tân Bình, TPHCM</p>
					<p className="tex-sm text-[#42495b] md:text-base">Địa chỉ: 149/35 Bành Văn Trân, Phường 7, Quận Tân Bình, TP. Hồ Chí Minh</p>
					<p className="tex-sm text-[#42495b] md:text-base">Điện thoại: 0909292848</p>
					<p className="tex-sm text-[#42495b] md:text-base">Zalo: 0909292848</p>
					<p className="tex-sm text-[#42495b] md:text-base">Email: perfumeandy@gmail.com</p>
				</div>
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">
						website andyperfume.com hiểu rằng quyền lợi của người dùng trong việc bảo vệ thông tin cá nhân cũng chính là trách nhiệm của chúng tôi. Trong bất kỳ
						trường hợp có thắc mắc, góp ý nào liên quan đến chính sách bảo mật của website andyperfume.com và liên quan đến việc thông tin cá nhân bị sử dụng
						sai mục đích hoặc phạm vi đã thông báo, việc tiếp nhận và xử lý khiếu nại được thực hiện theo các bước:
					</p>
			...
			<div className="flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2.5">
					...
					<p className="tex-sm text-[#42495b] md:text-base">
						...
						Theo đó, các tiêu chuẩn bảo mật thanh toán thẻ tại website andyperfume.com đảm bảo tuân thủ theo các tiêu chuẩn bảo mật ngành.
					</p>
				</div>
				...
				<div className="flex flex-col gap-2.5">
					...
					<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
						...
						<p className="tex-sm text-[#42495b] md:text-base">
							Chính sách bảo mật giao dịch trong thanh toán của website andyperfume.com áp dụng với Khách hàng:
						</p>
						<li>
						...
						<li>
							...
							nghiêm túc các biện pháp bảo mật cần thiết cho mọi hoạt động thanh toán thực hiện trên website andyperfume.com.
						</li>
					</ol>
				</div>
			</div>
