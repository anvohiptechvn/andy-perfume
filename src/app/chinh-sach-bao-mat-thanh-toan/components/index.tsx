	...
	return (
		<PageWrapper className="gap-3">
			...
			<p className="tex-sm text-[#42495b] md:text-base">
				...
				đó, các tiêu chuẩn bảo mật thanh toán thẻ tại website Parfumerie.vn đảm bảo tuân thủ theo các tiêu chuẩn bảo mật ngành.
			</p>
			...
			<div className="flex flex-col gap-2.5">
				...
				<p className="tex-sm text-[#42495b] md:text-base">Chính sách bảo mật giao dịch trong thanh toán của website Parfumerie.vn áp dụng với Khách hàng:</p>
				<p className="tex-sm text-[#42495b] md:text-base">
				...
				<p className="tex-sm text-[#42495b] md:text-base">
					...
					túc các biện pháp bảo mật cần thiết cho mọi hoạt động thanh toán thực hiện trên website Parfumerie.vn.
				</p>
			</div>
		</PageWrapper>
	);
