	...
	return (
		<PageWrapper>
			...
			<p className="tex-sm text-[#42495b] md:text-base">
				Parfumerie luôn hướng đến việc cung cấp dịch vụ vận chuyển tốt cùng mức phí vận chuyển phù hợp nhất cho tất cả các đơn hàng của Quý Khách Hàng. Chúng
			...
			<div className="flex flex-col gap-2.5">
				...
				<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
					<li>Giao hàng miễn phí với các đơn hàng trên 1.000.000 VNĐ</li>
					<li>
						Với các đơn hàng dưới 1.000.000 VNĐ, phí giao hàng tùy thuộc vào cước phí của bên đơn vị vận chuyển sau khi tính toán kích thước sản phẩm và địa
			...
			<div className="flex flex-col gap-2.5">
				...
				<ol className="list-inside list-disc space-y-1 text-sm text-[#42495b] md:text-base">
					<li>Trong nội thành khu vực Tp Hồ Chí Minh: dự kiến từ 1-2 ngày.</li>
				...
				<p className="tex-sm font-bold text-[#42495b] italic md:text-base">
					*** Đơn hàng đã được xác nhận, sản phẩm được giao đến nơi mà Quý khách hàng không nhận hàng (lý do từ khách hàng), Quý khách hàng vui lòng: (1) thanh
					...
					hàng liên quan sẽ được cấn trừ vào khoản tiền đã thanh toán/ đã đặt cọc của Quý khách hàng theo chính sách mua hàng tại Parfumerie.
				</p>
			</div>
